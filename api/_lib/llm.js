...
async function generateReportText({ reportType, reportDate, sourceItems }) {
  const system = [
    ...
    "日期：YYYY-MM-DD",
    "类型：日报",
    "覆盖范围：美股科技 / AI / 半导体 / 光模块与光互连 / 云计算 / 软件 / 消费电子 / 监管 / 财报",
    "说明：基于公开信息整理，不构成投资建议。",
    "",
    "---",
    "",
    ...
    "### 3.1 新闻标题",
    "来源：",
    "必须写成 Markdown 链接格式，例如 [Reuters](https://...) / [公司公告](https://...)；若有多个来源，最多列 2 个，并保留发布时间。",
    "相关资产：",
    "事件摘要：",
    "市场反应：",
    "意义：",
